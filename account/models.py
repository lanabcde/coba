...
class Profile(models.Model):
    ...
    nis = models.CharField(max_length=55, unique=True, null=True, verbose_name='NIS')
    no_hp = models.CharField(max_length=55, unique=True, null=True, verbose_name='Mo HP')
